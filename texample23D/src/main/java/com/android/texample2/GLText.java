...
public class GLText {
	...
	// R: [none]
	public void draw(String text, float x, float y, float z, float[] rotationMatrix)  {
	...
	public void draw(String text, float x, float y, float z, float angleDegX, float angleDegY, float angleDegZ) {
        ...
        Matrix.rotateM(rotationMatrix, 0, angleDegZ, 0, 0, 1);
        Matrix.rotateM(rotationMatrix, 0, angleDegX, 1, 0, 0);
        Matrix.rotateM(rotationMatrix, 0, angleDegY, 0, 1, 0);
        draw(text, x, y, z, rotationMatrix);
	}
