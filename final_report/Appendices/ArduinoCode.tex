...
\section{AR Code}
All of the Android application code is packaged in \code{ARLocationTracking}. It can be opened and compiled in Android Studio. It also contains code to handle the rendering
