...
\supervisor{Dr. Robert MacLeod \\ Dr. Ekram Hossain} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
The contribution page gives a concise statement of what novelty the thesis makes. In a
multi-author thesis, it also gives the attribution for each component of the work, including the
report.
\end{contributions}
